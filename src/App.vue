...
<template>
  <div class="row">
    <div>
      ...
      <h3 style="padding-top: 30px">Extended colors</h3>
      <table class="ex">
        <tr>
          <th>Color</th>
          <th>Name</th>
      ...
      <button @click="addNewExtendedColor">New extended color</button>

      <div style="height: 50px"></div>
      <input type="text" v-model="packageId">
      <button @click="download">Generate</button>
    </div>

    <div style="padding-left: 50px; flex: 1">
      <h3>Light scheme</h3>
      <SchemeColorBlock :scheme="customTheme.schemes.light" :extended-colors="customTheme.customColors" light/>

      <h3 style="padding-top: 30px">Dark scheme</h3>
      <SchemeColorBlock :scheme="customTheme.schemes.dark" :extended-colors="customTheme.customColors" :light="false"/>
    </div>
  </div>
</template>
